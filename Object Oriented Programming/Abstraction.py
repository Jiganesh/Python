...
Python Don't support Abstract class, So we have ABC(abstract Base Classes) Module.
We can use here to achieve abstract classes and will see what is abstract class and why we need it.
An abstract class can be considered as a pattern for other classes.
